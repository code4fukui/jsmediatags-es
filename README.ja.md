...
- [jsmediatags-es](https://code4fukui.github.io/jsmediatags-es/) は、MP3、MP4、FLAC ファイルのID3 タグ(ID3v1、ID3v2、AAC)を読み書きするためのJavaScript ライブラリです。
- [jsmediatags](https://github.com/aadsm/jsmediatags) のJavaScript/ESモジュールバージョンです。
- [browser-id3-writer](https://github.com/code4fukui/browser-id3-writer) を使ってメディアタグの書き込みが可能です。
